...
public class VaListTest extends NativeTestHelper {
    ...
    private static final BiFunction<Consumer<VaList.Builder>, ResourceScope, VaList> aixPPC64VaListScopedFactory
            = (builder, scope) -> AixPPC64Linker.newVaList(builder, scope);
    private static final BiFunction<Consumer<VaList.Builder>, ResourceScope, VaList> sysVPPC64leVaListScopedFactory
            = (builder, scope) -> SysVPPC64leLinker.newVaList(builder, scope);
    private static final BiFunction<Consumer<VaList.Builder>, ResourceScope, VaList> sysVS390xVaListScopedFactory
            = (builder, scope) -> SysVS390xLinker.newVaList(builder, scope);
