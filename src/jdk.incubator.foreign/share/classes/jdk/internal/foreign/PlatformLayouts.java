...
public class PlatformLayouts {
    public static <Z extends MemoryLayout> Z pick(Z aix, Z macos, Z sysv, Z win64, Z aarch64, Z sysvppc64le, Z sysvs390x) {
    ...
    /**
     * This class defines layout constants modelling standard primitive types supported by the x64 MacOS ABI.
     */
    public static final class MacOS {
         ...
         * The {@code va_list} native type, as it is passed to a function.
         */
        public static final ValueLayout.OfAddress C_VA_LIST = MacOS.C_POINTER;
    }
