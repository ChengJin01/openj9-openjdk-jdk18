...
/**
 * ABI implementation based on macOS ABI
 *
 * Note: This file is copied from x64/sysv with modification to accommodate the specifics
 * on macOS/x64 and might be updated accordingly in terms of VaList in the future.
 */
public final class MacOsx64Linker implements CLinker {
    private static MacOsx64Linker instance;

    static final long ADDRESS_SIZE = 64; // bits

    public static MacOsx64Linker getInstance() {
        if (instance == null) {
            instance = new MacOsx64Linker();
        }
        return instance;
    }
    ...
    public static VaList newVaList(Consumer<VaList.Builder> actions, ResourceScope scope) {
        MacOsx64VaList.Builder builder = MacOsx64VaList.builder(scope);
        actions.accept(builder);
        return builder.build();
    }

    public static VaList newVaListOfAddress(MemoryAddress ma, ResourceScope scope) {
        return MacOsx64VaList.ofAddress(ma, scope);
    }

    public static VaList emptyVaList() {
        return MacOsx64VaList.empty();
    }
}
