...
/**
 * This file is copied from x86/sysv as a placeholder for compilation as VaList on Linux/ppc64le
 * at Java level is not yet implemented for the moment and will be removed in the future
 * if not required in Linux/ppc64le.
 */
