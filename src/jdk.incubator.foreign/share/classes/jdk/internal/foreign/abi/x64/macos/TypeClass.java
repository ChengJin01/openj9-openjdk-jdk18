...
/**
 * Note: This file is copied from x64/sysv to support the type check of VaList
 * on macOS/x64 assuming there is no significant difference from the OS perspective.
 */
class TypeClass {
    enum Kind {
        STRUCT,
