...
import static jdk.internal.foreign.PlatformLayouts.MacOS;
...
/**
 * This file is copied from x64/sysv to enable VaList on macOS/x64
 * assuming there is no significant difference from the OS perspective.
 */
public non-sealed class MacOsx64VaList implements VaList, Scoped {
...
//    };
    static final GroupLayout LAYOUT = MemoryLayout.structLayout(
        MacOS.C_INT.withName("gp_offset"),
        MacOS.C_INT.withName("fp_offset"),
        MacOS.C_POINTER.withName("overflow_arg_area"),
        MacOS.C_POINTER.withName("reg_save_area")
...
//        FP_REG.withName("%xmm15")
    ...
    private MacOsx64VaList(MemorySegment segment, MemorySegment regSaveArea) {
        this.segment = segment;
        this.regSaveArea = regSaveArea;
    }

    private static MacOsx64VaList readFromSegment(MemorySegment segment) {
        MemorySegment regSaveArea = getRegSaveArea(segment);
        return new MacOsx64VaList(segment, regSaveArea);
    }
    ...
    static MacOsx64VaList.Builder builder(ResourceScope scope) {
        return new MacOsx64VaList.Builder(scope);
    }
    ...
    public VaList copy() {
        ...
        return new MacOsx64VaList(copy, regSaveArea);
    }
    ...
    public static non-sealed class Builder implements VaList.Builder {
        ...
        public VaList build() {
            ...
            return new MacOsx64VaList(vaListSegment, reg_save_area);
        }
    }
}
