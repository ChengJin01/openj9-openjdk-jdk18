		...
		switch (typeClass) {
			...
			case STRUCT -> {
				...
				if (isStruAddrRequired(struLayout)) {
					...
					MemorySegment struArgSegment = MemorySegment.ofAddress(struAddr, struArgSize, argAreaSegment.scope());
