...
/**
 * This file is copied from x86/sysv (Linux/x86_64) as a placeholder for compilation as VaList
 * on AIX/ppc64le at Java level is not yet implemented for the moment. The definition of VaList
 * corresponds to the underlying struct of va_list defined on AIX/ppc64le which appears to be a
 * 4-byte pointer to the actual argument value in debugging (totaly distinct from the existing
 * struct defined in Windows or Linux on x86_64). Thus, futher analysis on the struct is required
 * to understand how the struct is laid out in memory according to the description in the publisized
 * ABI document at https://refspecs.linuxfoundation.org/ELF/ppc64/PPC-elf64abi-1.9.pdf.
 */
...
//    };
    ...
    private AixPPC64VaList(MemorySegment segment, MemorySegment regSaveArea) {
    ...
    private static AixPPC64VaList readFromSegment(MemorySegment segment) {
        ...
        return new AixPPC64VaList(segment, regSaveArea);
    }
    ...
    public VaList copy() {
        ...
        return new AixPPC64VaList(copy, regSaveArea);
    }
    ...
    public static non-sealed class Builder implements VaList.Builder {
        ...
        public VaList build() {
            ...
            return new AixPPC64VaList(vaListSegment, reg_save_area);
        }
    }
}
